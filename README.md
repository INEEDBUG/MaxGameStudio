...
> [!NOTE]
> **当前稳定版为 `v3.0.4`。** `v2.5.17` 已因重大升级缺陷撤回；用户应直接升级到 `v3.0.4`。CS2 工作台、英雄联盟与无畏契约功能已经合并在同一个安装包中。
...
<p align="center">
  ...
  <a href="#v304-更新重点">v3.0.4 更新重点</a> •
  <a href="#核心功能">核心功能</a> •
  <a href="#安装">快速安装</a> •
...
> [!TIP]
> 本版本继续重点优化英雄联盟实时对局和导航体验，并新增四种区域语言选项。完整技术说明与安装包见 [v3.0.4 Release](https://github.com/INEEDBUG/MaxGameStudio/releases/tag/v3.0.4)；客户端更新弹窗会使用面向普通用户的“修复 / 新功能 / 优化”摘要。
...
| **v3.0.4 · 区域语言与实时对局** | 新增四种区域语言选项；修复侧栏收起；移除 League 重复导航；实时对局独立成页并采用快照渐进加载、全对组排识别和胜率队证据 | ✅ 当前稳定版 |
