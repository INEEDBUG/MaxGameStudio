...
> [!NOTE]
> **当前稳定版为 `v3.0.5`。** `v2.5.17` 已因重大升级缺陷撤回；用户应直接升级到 `v3.0.5`。CS2 工作台、英雄联盟与无畏契约功能已经合并在同一个安装包中。
...
<p align="center">
  ...
  <a href="#v305-更新重点">v3.0.5 更新重点</a> •
  <a href="#核心功能">核心功能</a> •
  <a href="#安装">快速安装</a> •
...
> [!TIP]
> 本版本改进多游戏首页与版本更新确认体验。完整技术说明与安装包见 [v3.0.5 Release](https://github.com/INEEDBUG/MaxGameStudio/releases/tag/v3.0.5)；客户端更新弹窗会使用面向普通用户的“修复 / 新功能 / 优化”摘要。
...
| **v3.0.5 · 首页、更新确认与 VALORANT CFG** | 新增独立首页、离线公告和反馈入口；更新必须明确确认；真拉伸增加 CFG 分辨率同步、备份、只读、解锁与恢复 | ✅ 当前稳定版 |
