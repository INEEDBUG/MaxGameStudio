...
> [!NOTE]
> **当前最新稳定版为 `v3.1.3`。** `v2.5.17` 已因重大升级缺陷撤回，内部候选 `v3.0.6` 从未发布；现有用户可以直接升级到 `v3.1.3`。CS2、内嵌英雄联盟工作台、无畏契约工具与外设调优均包含在同一个安装包中。
...
<p align="center">
  ...
  <a href="./docs/releases/v3.1.3.zh-CN.md">v3.1.3 更新说明</a> •
...
- **海克斯大乱斗 RESG 窗口** — 独立于 OP.GG 开关，自动跟随所选英雄和换选。
- **常用精选** — 可随时切回全部数据并记住选择；海克斯按品质和场次、装备组合按出装阶段和采用率展示前 3 项。
- **真正隐藏到系统托盘** — 工作台关闭选项不再缩到任务栏，点击托盘图标可恢复；返回主程序与记住选项保持可用。

完整更新说明见 [3.1.3 发布说明](./docs/releases/v3.1.3.zh-CN.md)。
...
> **当前稳定版本：`v3.1.3`。** 已签名安装包与更新清单通过仓库的稳定版 Release 工作流发布。
...
| **v3.1.3 · RESG 与托盘** | 海克斯大乱斗独立数据窗口、可逆精选视图与真正的系统托盘隐藏 | ✅ 当前稳定版 |
